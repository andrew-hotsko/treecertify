      ...
      >
        ...
        <div className="px-3 mb-2">
          <a
            ...
            className="flex items-center gap-3 rounded-lg px-3 py-3 text-sm font-medium text-neutral-400 hover:bg-neutral-700 hover:text-neutral-50 transition-colors"
          >
